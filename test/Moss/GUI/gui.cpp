...
// Stuff that needs intergating into Moss_GUI

/*! @brief X.*/
MOSS_API bool          Moss_ageButton(const char* str_id, uint64 user_texture_id, const Float2& Moss_age_size, const Float2& uv0 = Float2(0, 0), const Float2& uv1 = Float2(1, 1), const Float4& bg_col = Float4(0, 0, 0, 0), const Float4& tint_col = Float4(1, 1, 1, 1));
/*! @brief X.*/
MOSS_API bool          Checkbox(const char* label, bool* v);
/*! @brief X.*/
MOSS_API bool          RadioButton(const char* label, bool active);
/*! @brief X.*/
MOSS_API void          ToggleSwitch(bool active);
...
MOSS_API Moss_DrawList*   GetBackgroundDrawList();                                            // this draw list will be the first rendered one. Useful to quickly draw shapes/text behind dear Moss_gui contents.
MOSS_API Moss_DrawList*   GetForegroundDrawList();                                            // this draw list will be the last rendered one. Useful to quickly draw shapes/text over dear Moss_gui contents.
