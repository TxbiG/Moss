...
public:
	...
	/// Zero matrix
	static MOSS_INLINE Mat3x4	sZero() { return Mat44(Vec3::Zero(), Vec3::Zero(), Vec3::Zero(), Vec3::Zero()); }

	/// Identity matrix
	static MOSS_INLINE Mat3x4	Identity() {
	...
	static MOSS_INLINE Mat3x4	sNaN() { return Mat44(Vec3::NaN(), Vec3::NaN(), Vec3::NaN(), Vec3::NaN()); }
