...
public:
	...
	MOSS_INLINE float &operator[](uint32 inIndex) { MOSS_ASSERT(inIndex < 4); return mF32[inIndex]; }
	MOSS_INLINE float operator[](uint32 inIndex) const { MOSS_ASSERT(inIndex < 4); return mF32[inIndex]; }
