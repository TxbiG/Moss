...
template <class Key, class Value, class Hash = Hash<Key>, class KeyEqual = std::equal_to<Key>>
class TMap : public HashTable<Key, std::pair<Key, Value>, TMapDetail<Key, Value>, Hash, KeyEqual>
{
	using Base = HashTable<Key, std::pair<Key, Value>, TMapDetail<Key, Value>, Hash, KeyEqual>;
