...
// Create a std::hash for iVec3
MOSS_MAKE_HASHABLE(iVec3, t.GetX(), t.GetY(), t.GetZ())

MOSS_SUPRESS_WARNINGS_BEGIN

iVec3::iVec3(const Vec4 inRHS) {
...
iVec3::iVec3(const Vec4 inRHS) : iVec3(Vec4(inRHS)) { }

iVec3::iVec3(double inX, double inY, double inZ)
{
#if defined(MOSS_SIMD_AVX)
...
iVec3::Type iVec3::sFixW(TypeArg inValue)
{
#ifdef MOSS_FLOATING_POINT_EXCEPTIONS_ENABLED
	#if defined(MOSS_SIMD_AVX)
...
iVec3 iVec3::sLoadDouble3Unsafe(const Double3 &inV)
{
#if defined(MOSS_SIMD_AVX)
...
void iVec3::StoreDouble3(Double3 *outV) const
{
	outV->x = mF64[0];
	outV->y = mF64[1];
	outV->z = mF64[2];
...
iVec3 iVec3::sMin(const iVec3 inV1, const iVec3 inV2)
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_min_pd(inV1.mValue, inV2.mValue);
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_min_pd(inV1.mValue.mLow, inV2.mValue.mLow), _mm_min_pd(inV1.mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vminq_f64(inV1.mValue.val[0], inV2.mValue.val[0]), vminq_f64(inV1.mValue.val[1], inV2.mValue.val[1]) });
#else
	return iVec3(min(inV1.mF64[0], inV2.mF64[0]),
				 min(inV1.mF64[1], inV2.mF64[1]),
				 min(inV1.mF64[2], inV2.mF64[2]));
#endif
}

iVec3 iVec3::sMax(const iVec3 inV1, const iVec3 inV2)
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_max_pd(inV1.mValue, inV2.mValue);
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_max_pd(inV1.mValue.mLow, inV2.mValue.mLow), _mm_max_pd(inV1.mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vmaxq_f64(inV1.mValue.val[0], inV2.mValue.val[0]), vmaxq_f64(inV1.mValue.val[1], inV2.mValue.val[1]) });
#else
	return iVec3(max(inV1.mF64[0], inV2.mF64[0]),
				 max(inV1.mF64[1], inV2.mF64[1]),
				 max(inV1.mF64[2], inV2.mF64[2]));
#endif
}

iVec3 iVec3::sClamp(const iVec3 inV, const iVec3 inMin, const iVec3 inMax)
{
	return sMax(sMin(inV, inMax), inMin);
}

iVec3 iVec3::sEquals(const iVec3 inV1, const iVec3 inV2)
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_cmp_pd(inV1.mValue, inV2.mValue, _CMP_EQ_OQ);
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_cmpeq_pd(inV1.mValue.mLow, inV2.mValue.mLow), _mm_cmpeq_pd(inV1.mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vreinterpretq_f64_u64(vceqq_f64(inV1.mValue.val[0], inV2.mValue.val[0])), vreinterpretq_f64_u64(vceqq_f64(inV1.mValue.val[1], inV2.mValue.val[1])) });
#else
	return iVec3(inV1.mF64[0] == inV2.mF64[0]? cTrue : cFalse,
				 inV1.mF64[1] == inV2.mF64[1]? cTrue : cFalse,
				 inV1.mF64[2] == inV2.mF64[2]? cTrue : cFalse);
#endif
}

iVec3 iVec3::sLess(const iVec3 inV1, const iVec3 inV2)
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_cmp_pd(inV1.mValue, inV2.mValue, _CMP_LT_OQ);
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_cmplt_pd(inV1.mValue.mLow, inV2.mValue.mLow), _mm_cmplt_pd(inV1.mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vreinterpretq_f64_u64(vcltq_f64(inV1.mValue.val[0], inV2.mValue.val[0])), vreinterpretq_f64_u64(vcltq_f64(inV1.mValue.val[1], inV2.mValue.val[1])) });
#else
	return iVec3(inV1.mF64[0] < inV2.mF64[0]? cTrue : cFalse,
				 inV1.mF64[1] < inV2.mF64[1]? cTrue : cFalse,
				 inV1.mF64[2] < inV2.mF64[2]? cTrue : cFalse);
...
iVec3 iVec3::sLessOrEqual(const iVec3 inV1, const iVec3 inV2)
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_cmp_pd(inV1.mValue, inV2.mValue, _CMP_LE_OQ);
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_cmple_pd(inV1.mValue.mLow, inV2.mValue.mLow), _mm_cmple_pd(inV1.mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vreinterpretq_f64_u64(vcleq_f64(inV1.mValue.val[0], inV2.mValue.val[0])), vreinterpretq_f64_u64(vcleq_f64(inV1.mValue.val[1], inV2.mValue.val[1])) });
#else
	return iVec3(inV1.mF64[0] <= inV2.mF64[0]? cTrue : cFalse,
				 inV1.mF64[1] <= inV2.mF64[1]? cTrue : cFalse,
				 inV1.mF64[2] <= inV2.mF64[2]? cTrue : cFalse);
...
iVec3 iVec3::sGreater(const iVec3 inV1, const iVec3 inV2)
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_cmp_pd(inV1.mValue, inV2.mValue, _CMP_GT_OQ);
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_cmpgt_pd(inV1.mValue.mLow, inV2.mValue.mLow), _mm_cmpgt_pd(inV1.mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vreinterpretq_f64_u64(vcgtq_f64(inV1.mValue.val[0], inV2.mValue.val[0])), vreinterpretq_f64_u64(vcgtq_f64(inV1.mValue.val[1], inV2.mValue.val[1])) });
#else
	return iVec3(inV1.mF64[0] > inV2.mF64[0]? cTrue : cFalse,
				 inV1.mF64[1] > inV2.mF64[1]? cTrue : cFalse,
				 inV1.mF64[2] > inV2.mF64[2]? cTrue : cFalse);
...
iVec3 iVec3::sGreaterOrEqual(const iVec3 inV1, const iVec3 inV2)
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_cmp_pd(inV1.mValue, inV2.mValue, _CMP_GE_OQ);
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_cmpge_pd(inV1.mValue.mLow, inV2.mValue.mLow), _mm_cmpge_pd(inV1.mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vreinterpretq_f64_u64(vcgeq_f64(inV1.mValue.val[0], inV2.mValue.val[0])), vreinterpretq_f64_u64(vcgeq_f64(inV1.mValue.val[1], inV2.mValue.val[1])) });
#else
	return iVec3(inV1.mF64[0] >= inV2.mF64[0]? cTrue : cFalse,
				 inV1.mF64[1] >= inV2.mF64[1]? cTrue : cFalse,
				 inV1.mF64[2] >= inV2.mF64[2]? cTrue : cFalse);
...
iVec3 iVec3::sFusedMultiplyAdd(const iVec3 inMul1, const iVec3 inMul2, const iVec3 inAdd)
{
#if defined(MOSS_SIMD_AVX)
	...
	#endif
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vmlaq_f64(inAdd.mValue.val[0], inMul1.mValue.val[0], inMul2.mValue.val[0]), vmlaq_f64(inAdd.mValue.val[1], inMul1.mValue.val[1], inMul2.mValue.val[1]) });
#else
	return inMul1 * inMul2 + inAdd;
#endif
}

iVec3 iVec3::sSelect(const iVec3 inNotSet, const iVec3 inSet, const iVec3 inControl)
{
#if defined(MOSS_SIMD_AVX)
...
iVec3 iVec3::sOr(const iVec3 inV1, const iVec3 inV2)
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_or_pd(inV1.mValue, inV2.mValue);
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_or_pd(inV1.mValue.mLow, inV2.mValue.mLow), _mm_or_pd(inV1.mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vreinterpretq_f64_u64(vorrq_u64(vreinterpretq_u64_f64(inV1.mValue.val[0]), vreinterpretq_u64_f64(inV2.mValue.val[0]))),
				   vreinterpretq_f64_u64(vorrq_u64(vreinterpretq_u64_f64(inV1.mValue.val[1]), vreinterpretq_u64_f64(inV2.mValue.val[1]))) });
#else
	return iVec3(BitCast<double>(BitCast<uint64>(inV1.mF64[0]) | BitCast<uint64>(inV2.mF64[0])),
...
iVec3 iVec3::sXor(const iVec3 inV1, const iVec3 inV2)
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_xor_pd(inV1.mValue, inV2.mValue);
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_xor_pd(inV1.mValue.mLow, inV2.mValue.mLow), _mm_xor_pd(inV1.mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vreinterpretq_f64_u64(veorq_u64(vreinterpretq_u64_f64(inV1.mValue.val[0]), vreinterpretq_u64_f64(inV2.mValue.val[0]))),
...
iVec3 iVec3::sAnd(const iVec3 inV1, const iVec3 inV2)
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_and_pd(inV1.mValue, inV2.mValue);
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_and_pd(inV1.mValue.mLow, inV2.mValue.mLow), _mm_and_pd(inV1.mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vreinterpretq_f64_u64(vandq_u64(vreinterpretq_u64_f64(inV1.mValue.val[0]), vreinterpretq_u64_f64(inV2.mValue.val[0]))),
...
bool iVec3::TestAnyTrue() const
{
	return GetTrues() != 0;
}

bool iVec3::TestAllTrue() const
{
	return GetTrues() == 0x7;
}

bool iVec3::operator == (const iVec3 inV2) const
{
	return sEquals(*this, inV2).TestAllTrue();
}

bool iVec3::IsClose(const iVec3 inV2, double inMaxDistSq) const
{
	return (inV2 - *this).LengthSq() <= inMaxDistSq;
}

bool iVec3::IsNearZero(double inMaxDistSq) const
{
	return LengthSq() <= inMaxDistSq;
}

iVec3 iVec3::operator * (const iVec3 inV2) const
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_mul_pd(mValue, inV2.mValue);
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_mul_pd(mValue.mLow, inV2.mValue.mLow), _mm_mul_pd(mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vmulq_f64(mValue.val[0], inV2.mValue.val[0]), vmulq_f64(mValue.val[1], inV2.mValue.val[1]) });
#else
	return iVec3(mF64[0] * inV2.mF64[0], mF64[1] * inV2.mF64[1], mF64[2] * inV2.mF64[2]);
#endif
}

iVec3 iVec3::operator * (double inV2) const
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_mul_pd(mValue, _mm256_set1_pd(inV2));
#elif defined(MOSS_SIMD_SSE)
	__m128d v = _mm_set1_pd(inV2);
	return iVec3({ _mm_mul_pd(mValue.mLow, v), _mm_mul_pd(mValue.mHigh, v) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vmulq_n_f64(mValue.val[0], inV2), vmulq_n_f64(mValue.val[1], inV2) });
#else
	return iVec3(mF64[0] * inV2, mF64[1] * inV2, mF64[2] * inV2);
#endif
}

iVec3 operator * (double inV1, const iVec3 inV2)
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_mul_pd(_mm256_set1_pd(inV1), inV2.mValue);
#elif defined(MOSS_SIMD_SSE)
	__m128d v = _mm_set1_pd(inV1);
	return iVec3({ _mm_mul_pd(v, inV2.mValue.mLow), _mm_mul_pd(v, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vmulq_n_f64(inV2.mValue.val[0], inV1), vmulq_n_f64(inV2.mValue.val[1], inV1) });
#else
	return iVec3(inV1 * inV2.mF64[0], inV1 * inV2.mF64[1], inV1 * inV2.mF64[2]);
#endif
}
...
#elif defined(MOSS_SIMD_SSE)
	__m128d v = _mm_set1_pd(inV2);
	return iVec3({ _mm_div_pd(mValue.mLow, v), _mm_div_pd(mValue.mHigh, v) });
#elif defined(MOSS_SIMD_NEON)
	float64x2_t v = vdupq_n_f64(inV2);
	return iVec3({ vdivq_f64(mValue.val[0], v), vdivq_f64(mValue.val[1], v) });
#else
	return iVec3(mF64[0] / inV2, mF64[1] / inV2, mF64[2] / inV2);
#endif
}

iVec3 &iVec3::operator *= (double inV2)
{
#if defined(MOSS_SIMD_AVX)
...
iVec3 &iVec3::operator *= (const iVec3 inV2)
{
#if defined(MOSS_SIMD_AVX)
...
iVec3 iVec3::operator + (const Vec4 inV2) const
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_add_pd(mValue, _mm256_cvtps_pd(inV2.mValue));
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_add_pd(mValue.mLow, _mm_cvtps_pd(inV2.mValue)), _mm_add_pd(mValue.mHigh, _mm_cvtps_pd(_mm_shuffle_ps(inV2.mValue, inV2.mValue, _MM_SHUFFLE(2, 2, 2, 2)))) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vaddq_f64(mValue.val[0], vcvt_f64_f32(vget_low_f32(inV2.mValue))), vaddq_f64(mValue.val[1], vcvt_high_f64_f32(inV2.mValue)) });
#else
	return iVec3(mF64[0] + inV2.mF32[0], mF64[1] + inV2.mF32[1], mF64[2] + inV2.mF32[2]);
#endif
}
...
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_add_pd(mValue.mLow, inV2.mValue.mLow), _mm_add_pd(mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vaddq_f64(mValue.val[0], inV2.mValue.val[0]), vaddq_f64(mValue.val[1], inV2.mValue.val[1]) });
#else
	return iVec3(mF64[0] + inV2.mF64[0], mF64[1] + inV2.mF64[1], mF64[2] + inV2.mF64[2]);
#endif
}

iVec3 &iVec3::operator += (const Vec4 inV2)
{
#if defined(MOSS_SIMD_AVX)
...
#elif defined(MOSS_SIMD_SSE)
	__m128d zero = _mm_setzero_pd();
	return iVec3({ _mm_sub_pd(zero, mValue.mLow), _mm_sub_pd(zero, mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	#ifdef MOSS_CROSS_PLATFORM_DETERMINISTIC
		float64x2_t zero = vdupq_n_f64(0);
		return iVec3({ vsubq_f64(zero, mValue.val[0]), vsubq_f64(zero, mValue.val[1]) });
	#else
		return iVec3({ vnegq_f64(mValue.val[0]), vnegq_f64(mValue.val[1]) });
	#endif
#else
	#ifdef MOSS_CROSS_PLATFORM_DETERMINISTIC
		return iVec3(0.0 - mF64[0], 0.0 - mF64[1], 0.0 - mF64[2]);
	#else
		return iVec3(-mF64[0], -mF64[1], -mF64[2]);
	#endif
#endif
}
...
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_sub_pd(mValue.mLow, _mm_cvtps_pd(inV2.mValue)), _mm_sub_pd(mValue.mHigh, _mm_cvtps_pd(_mm_shuffle_ps(inV2.mValue, inV2.mValue, _MM_SHUFFLE(2, 2, 2, 2)))) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vsubq_f64(mValue.val[0], vcvt_f64_f32(vget_low_f32(inV2.mValue))), vsubq_f64(mValue.val[1], vcvt_high_f64_f32(inV2.mValue)) });
#else
	return iVec3(mF64[0] - inV2.mF32[0], mF64[1] - inV2.mF32[1], mF64[2] - inV2.mF32[2]);
#endif
}
...
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_sub_pd(mValue.mLow, inV2.mValue.mLow), _mm_sub_pd(mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vsubq_f64(mValue.val[0], inV2.mValue.val[0]), vsubq_f64(mValue.val[1], inV2.mValue.val[1]) });
#else
	return iVec3(mF64[0] - inV2.mF64[0], mF64[1] - inV2.mF64[1], mF64[2] - inV2.mF64[2]);
#endif
}
...
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_div_pd(mValue.mLow, inV2.mValue.mLow), _mm_div_pd(mValue.mHigh, inV2.mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vdivq_f64(mValue.val[0], inV2.mValue.val[0]), vdivq_f64(mValue.val[1], inV2.mValue.val[1]) });
#else
	return iVec3(mF64[0] / inV2.mF64[0], mF64[1] / inV2.mF64[1], mF64[2] / inV2.mF64[2]);
#endif
}
...
#elif defined(MOSS_SIMD_SSE)
	__m128d zero = _mm_setzero_pd();
	return iVec3({ _mm_max_pd(_mm_sub_pd(zero, mValue.mLow), mValue.mLow), _mm_max_pd(_mm_sub_pd(zero, mValue.mHigh), mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vabsq_f64(mValue.val[0]), vabsq_f64(mValue.val[1]) });
#else
	return iVec3(abs(mF64[0]), abs(mF64[1]), abs(mF64[2]));
#endif
}

iVec3 iVec3::Reciprocal() const
{
	return sReplicate(1.0) / mValue;
}

iVec3 iVec3::Cross(const iVec3 inV2) const
{
...
#else
	return iVec3(mF64[1] * inV2.mF64[2] - mF64[2] * inV2.mF64[1],
				 mF64[2] * inV2.mF64[0] - mF64[0] * inV2.mF64[2],
				 mF64[0] * inV2.mF64[1] - mF64[1] * inV2.mF64[0]);
#endif
}

double iVec3::Dot(const iVec3 inV2) const
{
#if defined(MOSS_SIMD_AVX)
...
double iVec3::LengthSq() const
{
	return Dot(*this);
}

iVec3 iVec3::Sqrt() const
{
#if defined(MOSS_SIMD_AVX)
	return _mm256_sqrt_pd(mValue);
#elif defined(MOSS_SIMD_SSE)
	return iVec3({ _mm_sqrt_pd(mValue.mLow), _mm_sqrt_pd(mValue.mHigh) });
#elif defined(MOSS_SIMD_NEON)
	return iVec3({ vsqrtq_f64(mValue.val[0]), vsqrtq_f64(mValue.val[1]) });
#else
	return iVec3(sqrt(mF64[0]), sqrt(mF64[1]), sqrt(mF64[2]));
#endif
}

double iVec3::Length() const
{
	return sqrt(Dot(*this));
}

iVec3 iVec3::Normalized() const
{
	return *this / Length();
}

bool iVec3::IsNormalized(double inTolerance) const
{
	return abs(LengthSq() - 1.0) <= inTolerance;
}

bool iVec3::IsNaN() const
{
#if defined(MOSS_SIMD_AVX512)
...
iVec3 iVec3::GetSign() const
{
	...
	return iVec3({ _mm_or_pd(_mm_and_pd(mValue.mLow, minus_one), one), _mm_or_pd(_mm_and_pd(mValue.mHigh, minus_one), one) });
#elif defined(MOSS_SIMD_NEON)
	uint64x2_t minus_one = vreinterpretq_u64_f64(vdupq_n_f64(-1.0f));
	uint64x2_t one = vreinterpretq_u64_f64(vdupq_n_f64(1.0f));
	return iVec3({ vreinterpretq_f64_u64(vorrq_u64(vandq_u64(vreinterpretq_u64_f64(mValue.val[0]), minus_one), one)),
				   vreinterpretq_f64_u64(vorrq_u64(vandq_u64(vreinterpretq_u64_f64(mValue.val[1]), minus_one), one)) });
#else
	return iVec3(std::signbit(mF64[0])? -1.0 : 1.0,
				 std::signbit(mF64[1])? -1.0 : 1.0,
				 std::signbit(mF64[2])? -1.0 : 1.0);
#endif
}

iVec3 iVec3::PrepareRoundToZero() const
{
	...
	return iVec3({ _mm_and_pd(mValue.mLow, mask), _mm_and_pd(mValue.mHigh, mask) });
#elif defined(MOSS_SIMD_NEON)
	uint64x2_t mask = vdupq_n_u64(~cDoubleToFloatMantissaLoss);
	return iVec3({ vreinterpretq_f64_u64(vandq_u64(vreinterpretq_u64_f64(mValue.val[0]), mask)),
...
iVec3 iVec3::PrepareRoundToInf() const
{
	// Float has 23 bit mantissa, double 52 bit mantissa => we lose 29 bits when converting from double to float
	constexpr uint64 cDoubleToFloatMantissaLoss = (1U << 29) - 1;
	...
	return iVec3({ _mm_blendv_pd(value_or_mantissa_loss_low, mValue.mLow, is_zero_low), _mm_blendv_pd(value_or_mantissa_loss_high, mValue.mHigh, is_zero_high) });
#elif defined(MOSS_SIMD_NEON)
	...
	return iVec3({ value_low, value_high });
#else
...
Vec4 iVec3::ToVec4RoundDown() const
{
	iVec3 to_zero = PrepareRoundToZero();
	iVec3 to_inf = PrepareRoundToInf();
	return Vec4(iVec3::sSelect(to_zero, to_inf, iVec3::sLess(*this, iVec3::sZero())));
}

Vec4 iVec3::ToVec4RoundUp() const
{
	iVec3 to_zero = PrepareRoundToZero();
	iVec3 to_inf = PrepareRoundToInf();
	return Vec4(iVec3::sSelect(to_inf, to_zero, iVec3::sLess(*this, iVec3::sZero())));
}
