...
#include <Moss/Variants/Vector/Double2.h>
...
public:
	...
	static MOSS_INLINE DVec2		Zero();

	/// Vectors with the principal axis
	static MOSS_INLINE DVec2		AxisX()										{ return DVec2(1, 0, 0); }
	static MOSS_INLINE DVec2		AxisY()										{ return DVec2(0, 1, 0); }
	static MOSS_INLINE DVec2		AxisZ()										{ return DVec2(0, 0, 1); }

	/// Replicate inV across all components
	static MOSS_INLINE DVec2		Replicate(double inV);

	/// Vector with all NaN's
	static MOSS_INLINE DVec2		NaN();

	/// Load 3 doubles from memory (reads 64 bits extra which it doesn't use)
	static MOSS_INLINE DVec2		LoadDouble3Unsafe(const Double3 &inV);
	...
	static MOSS_INLINE DVec2		Min(DVec2Arg inV1, DVec2Arg inV2);

	/// Return the maximum of each of the components
	static MOSS_INLINE DVec2		Max(DVec2Arg inV1, DVec2Arg inV2);

	/// Clamp a vector between min and max (component wise)
	static MOSS_INLINE DVec2		Clamp(DVec2Arg inV, DVec2Arg inMin, DVec2Arg inMax);

	/// Equals (component wise)
	static MOSS_INLINE DVec2		Equals(DVec2Arg inV1, DVec2Arg inV2);

	/// Less than (component wise)
	static MOSS_INLINE DVec2		Less(DVec2Arg inV1, DVec2Arg inV2);

	/// Less than or equal (component wise)
	static MOSS_INLINE DVec2		LessOrEqual(DVec2Arg inV1, DVec2Arg inV2);

	/// Greater than (component wise)
	static MOSS_INLINE DVec2		Greater(DVec2Arg inV1, DVec2Arg inV2);

	/// Greater than or equal (component wise)
	static MOSS_INLINE DVec2		GreaterOrEqual(DVec2Arg inV1, DVec2Arg inV2);

	/// Calculates inMul1 * inMul2 + inAdd
	static MOSS_INLINE DVec2		FusedMultiplyAdd(DVec2Arg inMul1, DVec2Arg inMul2, DVec2Arg inAdd);

	/// Component wise select, returns inNotSet when highest bit of inControl = 0 and inSet when highest bit of inControl = 1
	static MOSS_INLINE DVec2		Select(DVec2Arg inNotSet, DVec2Arg inSet, DVec2Arg inControl);

	/// Logical or (component wise)
	static MOSS_INLINE DVec2		Or(DVec2Arg inV1, DVec2Arg inV2);

	/// Logical xor (component wise)
	static MOSS_INLINE DVec2		Xor(DVec2Arg inV1, DVec2Arg inV2);

	/// Logical and (component wise)
	static MOSS_INLINE DVec2		And(DVec2Arg inV1, DVec2Arg inV2);
