...
static void sAddVertex(TStaticArray<Vec3, 1026> &ioVertices, Vec3Arg inVertex)
{
	bool found = false;
...
static void sCreateVertices(TStaticArray<Vec3, 1026> &ioVertices, Vec3Arg inDir1, Vec3Arg inDir2, Vec3Arg inDir3, int inLevel)
{
...
const TStaticArray<Vec3, 1026> Vec3::sUnitSphere = []() {
