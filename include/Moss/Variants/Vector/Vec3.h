...
class [[nodiscard]] alignas(MOSS_VECTOR_ALIGNMENT) Vec3
{
public:
	...
	MOSS_INLINE					Vec3(Type inRHS) : mValue(inRHS)				{ CheckW(); }

	/// Load 3 floats from memory
	explicit MOSS_INLINE		Vec3(const Float3 &inV);
	...
	MOSS_INLINE Vec3			Sqrt() const;

	/// Get normalized vector that is perpendicular to this vector
	MOSS_INLINE Vec3			GetNormalizedPerpendicular() const;
