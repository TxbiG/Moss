...
///		class Foo
///		{
///			MOSS_DECLARE_RTTI_VIRTUAL_BASE(Foo)
///		}
///
///		class Bar : public Foo
///		{
///			MOSS_DECLARE_RTTI_VIRTUAL(Bar)
///		};
///
/// Implementation file:
///
///		MOSS_IMPLEMENT_RTTI_VIRTUAL_BASE(Foo)
///		{
///		}
///
///		MOSS_IMPLEMENT_RTTI_VIRTUAL(Bar)
///		{
///			MOSS_ADD_BASE_CLASS(Bar, Foo) // Multiple inheritance is allowed, just do MOSS_ADD_BASE_CLASS for every base class
///		}
///
...
///		class Foo
///		{
///			MOSS_DECLARE_RTTI_ABSTRACT_BASE(Foo)
///
///		public:
...
/// Implementation file:
///
///		MOSS_IMPLEMENT_RTTI_ABSTRACT_BASE(Foo)
///		{
///		}
///
///		MOSS_IMPLEMENT_RTTI_VIRTUAL(Bar)
///		{
///			MOSS_ADD_BASE_CLASS(Bar, Foo)
///		}
///
...
protected:
	...
	TStaticArray<BaseClass, 4>	mBaseClasses;												///< Names of base classes
...
#ifdef MOSS_OBJECT_STREAM
	TStaticArray<SerializableAttribute, 32> mAttributes;										///< All attributes of this class
#endif // MOSS_OBJECT_STREAM
};
...
// MOSS_DECLARE_RTTI_NON_VIRTUAL
#define MOSS_DECLARE_RTTI_NON_VIRTUAL(linkage, class_name)															\
public:																												\
...
// MOSS_IMPLEMENT_RTTI_NON_VIRTUAL
#define MOSS_IMPLEMENT_RTTI_NON_VIRTUAL(class_name)																	\
...
// MOSS_DECLARE_RTTI_OUTSIDE_CLASS
#define MOSS_DECLARE_RTTI_OUTSIDE_CLASS(linkage, class_name)															\
...
// MOSS_IMPLEMENT_RTTI_OUTSIDE_CLASS
#define MOSS_IMPLEMENT_RTTI_OUTSIDE_CLASS(class_name)																\
	RTTI *						GetRTTIOfType(class_name *)															\
	{																												\
...
#define MOSS_DECLARE_RTTI_HELPER(linkage, class_name, modifier)														\
public:																												\
	MOSS_OVERRIDE_NEW_DELETE																							\
	friend linkage RTTI *		GetRTTIOfType(class_name *);														\
...
// MOSS_DECLARE_RTTI_VIRTUAL - for derived classes with RTTI
#define MOSS_DECLARE_RTTI_VIRTUAL(linkage, class_name)																\
	MOSS_DECLARE_RTTI_HELPER(linkage, class_name, override)

// MOSS_IMPLEMENT_RTTI_VIRTUAL
#define MOSS_IMPLEMENT_RTTI_VIRTUAL(class_name)																		\
	RTTI *			GetRTTIOfType(class_name *)																		\
	{																												\
		static RTTI rtti(#class_name, sizeof(class_name), []() -> void * { return new class_name; }, [](void *inObject) { delete (class_name *)inObject; }, &class_name::sCreateRTTI); \
		return &rtti;																								\
	...
	{																												\
		return MOSS_RTTI(class_name);																				\
	}																												\
	const void *				class_name::CastTo(const RTTI *inRTTI) const										\
	{																												\
		return MOSS_RTTI(class_name)->CastTo((const void *)this, inRTTI);											\
	}																												\
	void						class_name::sCreateRTTI(RTTI &inRTTI)												\

// MOSS_DECLARE_RTTI_VIRTUAL_BASE - for concrete base class that has RTTI
#define MOSS_DECLARE_RTTI_VIRTUAL_BASE(linkage, class_name)															\
	MOSS_DECLARE_RTTI_HELPER(linkage, class_name, )

// MOSS_IMPLEMENT_RTTI_VIRTUAL_BASE
#define MOSS_IMPLEMENT_RTTI_VIRTUAL_BASE(class_name)																	\
	MOSS_IMPLEMENT_RTTI_VIRTUAL(class_name)

// MOSS_DECLARE_RTTI_ABSTRACT - for derived abstract class that have RTTI
#define MOSS_DECLARE_RTTI_ABSTRACT(linkage, class_name)																\
	MOSS_DECLARE_RTTI_HELPER(linkage, class_name, override)

// MOSS_IMPLEMENT_RTTI_ABSTRACT
#define MOSS_IMPLEMENT_RTTI_ABSTRACT(class_name)																		\
	RTTI *						GetRTTIOfType(class_name *)															\
	{																												\
...
// MOSS_DECLARE_RTTI_ABSTRACT_BASE - for abstract base class that has RTTI
#define MOSS_DECLARE_RTTI_ABSTRACT_BASE(linkage, class_name) MOSS_DECLARE_RTTI_HELPER(linkage, class_name, )

// MOSS_IMPLEMENT_RTTI_ABSTRACT_BASE
#define MOSS_IMPLEMENT_RTTI_ABSTRACT_BASE(class_name) MOSS_IMPLEMENT_RTTI_ABSTRACT(class_name)

//////////////////////////////////////////////////////////////////////////////////////////
// Declare an RTTI class for registering with the factory
//////////////////////////////////////////////////////////////////////////////////////////

#define MOSS_DECLARE_RTTI_FOR_FACTORY(linkage, class_name) 		\
	linkage RTTI* GetRTTIOfType(class class_name *);

#define JMOSS_DECLARE_RTTI_WITH_NAMESPACE_FOR_FACTORY(linkage, name_space, class_name)								\
...
#define MOSS_RTTI(class_name) GetRTTIOfType(static_cast<class_name *>(nullptr))
...
// class A { class B { }; }
//
// Now use MOSS_RENAME_CLASS(B, A::B) to avoid conflicts with other classes named B
//////////////////////////////////////////////////////////////////////////////////////////

// MOSS_RENAME_CLASS
#define MOSS_RENAME_CLASS(class_name, new_name)	inRTTI.SetName(#new_name);
...
#define MOSS_BASE_CLASS_OFFSET(inClass, inBaseClass)	((int(uint64((inBaseClass *)((inClass *)0x10000))))-0x10000)

// MOSS_ADD_BASE_CLASS
#define MOSS_ADD_BASE_CLASS(class_name, base_class_name) inRTTI.AddBaseClass(MOSS_RTTI(base_class_name), MOSS_BASE_CLASS_OFFSET(class_name, base_class_name));
...
template <class Type>
inline bool IsType(const Type *inObject, const RTTI *inRTTI) { return inObject == nullptr || *inObject->GetRTTI() == *inRTTI; }

template <class Type>
inline bool IsType(const RefConst<Type> &inObject, const RTTI *inRTTI) { return inObject == nullptr || *inObject->GetRTTI() == *inRTTI; }

template <class Type>
inline bool IsType(const Ref<Type> &inObject, const RTTI *inRTTI) { return inObject == nullptr || *inObject->GetRTTI() == *inRTTI; }

/// Check if inObject is or is derived from DstType
template <class Type>
inline bool IsKindOf(const Type *inObject, const RTTI *inRTTI) { return inObject == nullptr || inObject->GetRTTI()->IsKindOf(inRTTI); }

template <class Type>
inline bool IsKindOf(const RefConst<Type> &inObject, const RTTI *inRTTI) { return inObject == nullptr || inObject->GetRTTI()->IsKindOf(inRTTI); }

template <class Type>
inline bool IsKindOf(const Ref<Type> &inObject, const RTTI *inRTTI) { return inObject == nullptr || inObject->GetRTTI()->IsKindOf(inRTTI); }
...
inline const DstType *StaticCast(const SrcType *inObject) { return static_cast<const DstType *>(inObject); }

template <class DstType, class SrcType, std::enable_if_t<std::is_base_of_v<DstType, SrcType> || std::is_base_of_v<SrcType, DstType>, bool> = true>
inline DstType *StaticCast(SrcType *inObject) { return static_cast<DstType *>(inObject); }

template <class DstType, class SrcType, std::enable_if_t<std::is_base_of_v<DstType, SrcType> || std::is_base_of_v<SrcType, DstType>, bool> = true>
inline const DstType *StaticCast(const RefConst<SrcType> &inObject) { return static_cast<const DstType *>(inObject.GetPtr()); }

template <class DstType, class SrcType, std::enable_if_t<std::is_base_of_v<DstType, SrcType> || std::is_base_of_v<SrcType, DstType>, bool> = true>
inline DstType *StaticCast(const Ref<SrcType> &inObject) { return static_cast<DstType *>(inObject.GetPtr()); }

/// Cast inObject to DstType, returns nullptr on failure
template <class DstType, class SrcType>
inline const DstType *DynamicCast(const SrcType *inObject) { return inObject != nullptr? reinterpret_cast<const DstType *>(inObject->CastTo(MOSS_RTTI(DstType))) : nullptr; }

template <class DstType, class SrcType>
inline DstType *DynamicCast(SrcType *inObject) { return inObject != nullptr? const_cast<DstType *>(reinterpret_cast<const DstType *>(inObject->CastTo(MOSS_RTTI(DstType)))) : nullptr; }

template <class DstType, class SrcType>
inline const DstType *DynamicCast(const RefConst<SrcType> &inObject) { return inObject != nullptr? reinterpret_cast<const DstType *>(inObject->CastTo(MOSS_RTTI(DstType))) : nullptr; }
