...
public:
	...
	const TArray<BodyCreationSettings>& GetBodies() const								{ return mBodies; }
	TArray<BodyCreationSettings>& GetBodies()										{ return mBodies; }
	...
	const TArray<ConnectedConstraint>& GetConstraints() const { return mConstraints; }
	TArray<ConnectedConstraint>& GetConstraints() { return mConstraints; }

	/// Get number of bodies in this scene
	size_t GetNumSoftBodies() const { return mSoftBodies.size(); }

	/// Access to the soft body settings for this scene
	const TArray<SoftBodyCreationSettings>& GetSoftBodies() const { return mSoftBodies; }
	TArray<SoftBodyCreationSettings>& GetSoftBodies() { return mSoftBodies; }
...
private:
	...
	TArray<BodyCreationSettings> mBodies;

	/// Constraints that are part of this scene
	TArray<ConnectedConstraint> mConstraints;
