...
public:
	...
	struct JPH_EXPORT SkinWeight : public JPH_HairSkinWeight { JPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(JPH_EXPORT, SkinWeight) };

	/// Information about where a hair strand is attached to the scalp mesh
	struct JPH_EXPORT SkinPoint : public JPH_HairSkinPoint { JPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(JPH_EXPORT, SkinPoint) };
	...
	struct JPH_EXPORT HairMaterial {
