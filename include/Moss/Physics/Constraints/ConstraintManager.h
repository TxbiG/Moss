...
public:
	/// Constructor
	MOSS_INLINE explicit			CalculateSolverSteps(const PhysicsSettings &inSettings) : mSettings(inSettings) { }
...
public:
	template <class Type>
	MOSS_INLINE void				operator () (const Type *) const
	{
		/* Nothing to do */
	}
};
...
private:
	...
	public:
		...
		void					GetAllBodyPairsSorted(TArray<const BPKeyValue *> &outAll) const;
		void					GetAllManifoldsSorted(const CachedBodyPair &inBodyPair, TArray<const MKeyValue *> &outAll) const;
		void					GetAllCCDManifoldsSorted(TArray<const MKeyValue *> &outAll) const;
	...
	using WorldContactPoints = TStaticArray<WorldContactPoint, MaxContactPoints>;
	...
	public:
		...
		MOSS_INLINE void			GetTangents(Vec3 &outTangent1, Vec3 &outTangent2) const
		{
...
private:
	...
	template <EMotionType Type1, EMotionType Type2>
	MOSS_INLINE void				TemplatedCalculateFrictionAndNonPenetrationConstraintProperties(ContactConstraint &ioConstraint, const ContactSettings &inSettings, float inDeltaTime, Vec3Arg inGravityDeltaTime, RMat44Arg inTransformBody1, RMat44Arg inTransformBody2, const Body &inBody1, const Body &inBody2);
	...
	template <EMotionType Type1, EMotionType Type2>
	MOSS_INLINE static void		sWarmStartConstraint(ContactConstraint &ioConstraint, MotionProperties *ioMotionProperties1, MotionProperties *ioMotionProperties2, float inWarmStartImpulseRatio);
	...
	template <EMotionType Type1, EMotionType Type2>
	MOSS_INLINE static bool		sSolveVelocityConstraint(ContactConstraint &ioConstraint, MotionProperties *ioMotionProperties1, MotionProperties *ioMotionProperties2);
