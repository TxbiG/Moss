...
#pragma once
	...
	//#error This file should only be included when MOSS_DEBUG_RENDERER is defined
...
class MOSS_DEBUG_RENDERER_EXPORT DebugRenderer : public NonCopyable
{
public:
	...
	/// A single triangle
	class MOSS_DEBUG_RENDERER_EXPORT Triangle
	{
	public:
							Triangle() = default;
...
private:
	...
	MOSS_MAKE_HASH_STRUCT(SwingConeLimits, SwingConeLimitsHasher, t.mSwingYHalfAngle, t.mSwingZHalfAngle)

	using SwingConeBatches = TMap<SwingConeLimits, GeometryRef, SwingConeLimitsHasher>;
	...
	MOSS_MAKE_HASH_STRUCT(SwingPyramidLimits, SwingPyramidLimitsHasher, t.mMinSwingYAngle, t.mMaxSwingYAngle, t.mMinSwingZAngle, t.mMaxSwingZAngle)

	using SwingPyramidBatches = TMap<SwingPyramidLimits, GeometryRef, SwingPyramidLimitsHasher>;
	SwingPyramidBatches		mSwingPyramidLimits;
	SwingPyramidBatches		mPrevSwingPyramidLimits;

	using PieBatces = TMap<float, GeometryRef>;
	...
	MOSS_MAKE_HASH_STRUCT(TaperedCylinder, TaperedCylinderHasher, t.mTop, t.mBottom, t.mTopRadius, t.mBottomRadius)

	using TaperedCylinderBatces = TMap<TaperedCylinder, GeometryRef, TaperedCylinderHasher>;
