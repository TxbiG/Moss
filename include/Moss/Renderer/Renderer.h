...
#include <Moss/Renderer/Surface.h>
#include <Moss/Moss_Platform.h>
#include <Moss/Renderer/Frustum.h>
#include <Moss/Renderer/PipelineState.h>
#include <Moss/Renderer/VertexShader.h>
#include <Moss/Renderer/PixelShader.h>
#include <Moss/Renderer/RenderPrimitive.h>
#include <Moss/Renderer/RenderInstances.h>
#include <memory>
...
public:
	...
	/// Initialize renderer
	virtual void					Initialize(Moss_Window *inWindow);
...
protected:
	...
	Moss_Window*				    mWindow = nullptr;					///< The window we're rendering to
